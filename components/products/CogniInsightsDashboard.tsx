        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="font-semibold text-brand-white">Analytics Dashboard</div>
                <div className="text-sm text-brand-grey">Real-time insights</div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-brand-medium-grey/10 rounded-lg p-4 text-center border border-brand-medium-grey/20">
              <div className="text-2xl font-bold text-brand-yellow">2.4M</div>
              <div className="text-xs text-brand-yellow-light">Data Points</div>
            </div>
            <div className="bg-brand-medium-grey/10 rounded-lg p-4 text-center border border-brand-medium-grey/20">
              <div className="text-2xl font-bold text-brand-yellow">98.7%</div>
              <div className="text-xs text-brand-yellow-light">Accuracy</div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-brand-medium-grey/50 rounded-lg border border-brand-yellow/10">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-brand-white">Customer Behavior</span>
              </div>
              <span className="text-xs text-brand-yellow font-medium">Trending Up</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-brand-medium-grey/50 rounded-lg border border-brand-yellow/10">
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-brand-yellow rounded-full flex items-center justify-center">
                ...
                <span className="text-sm font-medium text-brand-white">Revenue Analytics</span>
              </div>
              <span className="text-xs text-brand-yellow font-medium">Stable</span>
            </div>
          </div>
        </div>
      </div>
