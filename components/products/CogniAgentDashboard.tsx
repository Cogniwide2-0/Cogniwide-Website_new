        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="font-semibold text-brand-white">Agent Orchestrator</div>
                <div className="text-sm text-brand-grey">Multi-agent coordination</div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-brand-medium-grey/10 rounded-lg p-4 text-center border border-brand-medium-grey/20">
              ...
              <div className="text-xs text-brand-yellow-light">Active Agents</div>
            </div>
            <div className="bg-brand-medium-grey/10 rounded-lg p-4 text-center border border-brand-medium-grey/20">
              <div className="text-2xl font-bold text-brand-yellow">95%</div>
              <div className="text-xs text-brand-yellow-light">Automation Rate</div>
            </div>
            <div className="bg-brand-medium-grey/10 rounded-lg p-4 text-center border border-brand-medium-grey/20">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-brand-medium-grey/50 rounded-lg border border-brand-yellow/10">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-brand-white">Customer Service Agent</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-brand-medium-grey/50 rounded-lg border border-brand-yellow/10">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-brand-white">Data Analysis Agent</span>
              </div>
              <span className="text-xs text-brand-yellow font-medium">Analyzing</span>
            </div>
            <div className="flex items-center justify-between p-3 bg-brand-medium-grey/50 rounded-lg border border-brand-yellow/10">
              <div className="flex items-center space-x-3">
                <div className="w-6 h-6 bg-brand-yellow rounded-full flex items-center justify-center">
                ...
                <span className="text-sm font-medium text-brand-white">Workflow Orchestrator</span>
              </div>
              <span className="text-xs text-brand-yellow font-medium">Coordinating</span>
            </div>
          </div>
        </div>
      </div>
